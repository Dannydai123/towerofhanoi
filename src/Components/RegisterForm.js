...
class RegisterForm extends Component {
  ...
  handlesubmit = (e) => {
    let fnhelplocal,
      lnhelplocal,
      emailhelplocal,
      signupflaglocal = false;

    e.preventDefault();
    const { firstname, lastname, email, fnhelp, lnhelp, emailhelp } =
      this.state;
    if (firstname) {
      fnhelplocal = "";
        ...
        <div className="card-body">
          <form onSubmit={this.handlesubmit}>
            <div className="form-group">
              ...
              />
              <small id="firstnameHelp" className="form-text text-white">
                {fnhelp}{" "}
              </small>
            </div>
            <div className="form-group">
              ...
              />
              <small id="lastnameHelp" className="form-text text-white">
                {" "}
                {lnhelp}
              </small>
            </div>
